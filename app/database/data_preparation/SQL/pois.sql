...
-- Reclassification soccer & co
update pois set amenity = (tags -> 'sport')
where amenity in ('sports','sport');

-- Reclassification Playgrounds
update pois set access = 'public'
where amenity = 'playground' AND access = 'yes';
